            ...
            <header className="bg-white shadow-sm">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <div>
                            <h1 className="text-xl font-semibold text-blue-600">Client Portal</h1>
            ...
            <div className="container mx-auto px-4 py-8">
                <Tabs defaultValue="services" className="w-full">
                        ...
                        {clientServices.filter(service =>
                            ...
                            <Card>
                                <CardContent className="pt-6 text-center">
                                    ...
                                    <p>No services registered for your account.</p>
                                </CardContent>
                            </Card>
                        ) : (
                                    ...
                                    .map((service) => (
                                        <Card key={service.id}>
                                            <CardHeader>
                                                ...
                                                <CardDescription>
                                                    Date: {format(new Date(service.date), "MM/dd/yyyy")}
                                                </CardDescription>
                                            </CardHeader>
                                            <CardContent>
                                                ...
                                                <p className="mb-2">
                                                    ...
                                                    <span className={`ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${service.serviceStatus === 'completed'
                                                ...
                                                <p>
                                                    ...
                                                    <span className={`ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${service.paymentStatus === 'paid'
                                                            ? 'bg-green-100 text-green-800'
                                            ...
                                            <CardFooter>
                                                <p className="text-lg font-bold">Total: ${service.totalValue.toFixed(2)}</p>
                                            </CardFooter>
                                        </Card>
                                    ))}
                            </div>
                    ...
                    <TabsContent value="equipment">
                        <h2 className="text-xl font-semibold mb-4">Your Equipment</h2>
                        {clientEquipment.length === 0 ? (
                            <Card>
                                <CardContent className="pt-6 text-center">
                                    <AlertTriangle className="h-12 w-12 text-amber-500 mx-auto mb-2" />
                                    <p>No equipment registered for your account.</p>
                                </CardContent>
                            </Card>
                        ) : (
                                ...
                                {clientEquipment.map((equipment) => (
                                    <Card key={equipment.id}>
                                        <CardHeader>
                                            ...
                                            <CardDescription>Model: {equipment.model}</CardDescription>
                                        </CardHeader>
                                        <CardContent>
                                            <p className="mb-2"><strong>Type:</strong> {equipment.type}</p>
                                            <p className="mb-2"><strong>Serial No:</strong> {equipment.serialNumber || 'N/A'}</p>
                                            <p className="mb-2">
                                                <strong>Status:</strong>
                                                <span className={`ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${equipment.status === 'operational'
                                                        ? 'bg-green-100 text-green-800'
                                        ...
                                        <CardFooter>
                                            <p className="text-sm text-gray-500 italic">Notes: {equipment.notes || 'No notes'}</p>
                                        </CardFooter>
                                    </Card>
                                ))}
                            </div>
                        ...
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    ...
                                    Date {paymentDateFilter === 'asc' ? '↑' : paymentDateFilter === 'desc' ? '↓' : ''}
                                </Button>
                                <Button
                                    variant="outline"
                                    size="sm"
                                ...
                                >
                                    <BarChart2 className="mr-2 h-4 w-4" />
                                    Value {paymentValueFilter === 'asc' ? '↑' : paymentValueFilter === 'desc' ? '↓' : ''}
                                </Button>
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button variant="outline" size="sm">
                        ...
                        {clientServices.length === 0 ? (
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Service payment history</CardDescription>
                                </CardHeader>
                                <CardContent>
                                                ...
                                                {clientServices
                                                    ...
                                                    .map((service) => (
                                                        <tr key={service.id} className="border-t">
                                                            ...
                                                            <td className="p-2">{format(new Date(service.date), "MM/dd/yyyy")}</td>
                                                            <td className="p-2">${service.totalValue.toFixed(2)}</td>
                                                            <td className="p-2">
